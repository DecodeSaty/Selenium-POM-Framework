...
import torus.labs.factory.abstractFactory.DriverManagerAbstract;
import torus.labs.factory.abstractFactory.DriverManagerFactoryAbstract;
import torus.labs.utils.CookieUtils;
...
public class BaseTest {
    ...
    public synchronized void quitDriver(@Optional String browser, ITestResult result) throws InterruptedException, IOException {
        ...
        if(result.getStatus() == ITestResult.FAILURE){
            File destFile = new File("screenshot" +  File.separator +
